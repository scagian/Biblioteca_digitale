 ...
 */
public class Pannello_revisoreAcq extends javax.swing.JFrame {
    
    private V_Opere view;
    private FCPagina controllerP;

    
    public Pannello_revisoreAcq(V_Opere v, FCPagina cp) {
        this.view = v;
        this.controllerP = cp;
        initComponents();
        myInitComponents();
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seleziona un'opera con acquisizioni da revisionare");
    ...
    con acquisizione in attesa di revisione.
    ...
    */
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!jList1.isSelectionEmpty()) {
            ...
            RevAcq_pagine new_view = new RevAcq_pagine(view, this.controllerP, this);
